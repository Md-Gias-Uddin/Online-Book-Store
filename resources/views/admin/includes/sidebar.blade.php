<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapse-inner" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
      ...
      <li class="nav-item">
        ...
        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Choose Option</h6>
            <a class="collapse-item" href="{{url('manufacturer/add')}}">Add Manufacture</a>
            <a class="collapse-item" href="{{url('manufacturer/manage')}}">Manage Manufacture</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
       ...
       <li class="nav-item">
        <a class="nav-link" href="{{url('order/manage/')}}">
